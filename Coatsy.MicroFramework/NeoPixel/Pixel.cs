...
namespace Coatsy.Netduino.NeoPixel
{
    ...
    public class Pixel
    {
        ...
        ///// <summary>
        ///// Creates a new pixel with an initial colour
        ///// </summary>
        ///// <param name="pixelColour">Initial Colour</param>
        //public Pixel(PixelColour pixelColour) {
        //    var pixel = NeoPixelBase.getPixel(pixelColour);
        //    Red = pixel.Red;
        //    Green = pixel.Green;
        //    Blue = pixel.Blue;
        //}
