...
namespace Coatsy.MicroFramework.NeoPixel {
    public class NeoPixelGrid : NeoPixelGridBase {
        ...
        public Pixel[] coolPalette = new Pixel[] { Pixel.CoolColours.WarmRed, Pixel.CoolColours.WarmGreen, Pixel.CoolColours.WarmBlue, new Pixel(0, 0, 0) };
        ...
        public void StarSquare(Pixel[] coolPalette)
        {
            for (int i = 0; i < 50; i++)
            {
